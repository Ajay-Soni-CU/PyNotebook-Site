...
> “No installation. No dependencies. Just open your browser — and start coding smarter.”

This project redefines the boundaries of web-based development by merging a **Pyodide-powered Python runtime** with an **AI assistant** that understands your code context, provides auto-completions, generates scripts, and explains concepts — all locally and privately.
...
- **Multi-Turn Conversations:** Continue discussions — AI retains session memory during your work.
...
- **Dual Theme System:** Switch seamlessly between **Light** ☀️ and **Dark** 🌙 modes.
...
1️⃣ **Launch:** Open `index.html` in any modern browser.  
2️⃣ **Wait for Kernel:** Pyodide initializes automatically.  
3️⃣ **Start Coding:** Create cells and execute with `Ctrl+Enter`.  
4️⃣ **Trigger AI:** Use `@` followed by your request or open the **AI chat panel** (robot icon).  
...
- **Fully Private:** All Python execution happens locally — data never leaves your browser.
